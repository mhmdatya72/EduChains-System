...
<input type="text" id="fsdate" class="text-center form-control datefilter" name="from" value="<?php echo e(request()->get('from')); ?>" placeholder="<?php echo e(trans('admin/main.start_date')); ?>">
</div>
</div>
</div>
...
<div class="input-group">
<input type="text" id="lsdate" class="text-center form-control datefilter" name="to" value="<?php echo e(request()->get('to')); ?>" placeholder="<?php echo e(trans('admin/main.end_date')); ?>">
</div>
</div>
</div>
...
data-placeholder="<?php echo e(trans('admin/main.search_classes')); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/inomtech/educhains.co/resources/views/admin/webinars/assignments/lists.blade.php ENDPATH**/ ?>