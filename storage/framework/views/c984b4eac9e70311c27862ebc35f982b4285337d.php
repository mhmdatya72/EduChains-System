    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">EduChains</h1>
                <h5 class="font-weight-normal text-muted-transparent"> educational platform</h5>
              </div>
              All rights reserved for <a class="text-light bb" target="_blank" href="">EduChains</a> By <a class="text-light bb" target="_blank" href="https://wa.me/+201094029664">Soker</a>
            </div>
          </div>
            </div>
...
<?php /**PATH C:\Users\moul\Desktop\inom\New folder\educhains\resources\views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>