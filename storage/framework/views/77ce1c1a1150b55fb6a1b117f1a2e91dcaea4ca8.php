        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <?php echo e(trans('update.overdue_history')); ?>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?php echo e(getAdminPanelUrl("/financial/installments/overdue_history/export")); ?>" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo e(trans('update.paid_date')); ?></th>
                                        <th class="text-center"><?php echo e(trans('update.late_days')); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if(!empty($order->paid_at)): ?>
                                                    <span class="text-success"><?php echo e(trans('public.paid')); ?></span>
                                                <?php else: ?>
                                                    <span class="text-danger"><?php echo e(trans('update.unpaid')); ?></span>
                                                <?php endif; ?>
                                            </td>

                                            <td class="text-center"><?php echo e(!empty($order->paid_at) ? dateTimeFormat($order->paid_at, 'j M Y') : '-'); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\moul\Desktop\inom\educhains\educhains\resources\views/admin/financial/installments/overdue_history.blade.php ENDPATH**/ ?>