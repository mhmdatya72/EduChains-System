            ...
            <form action="{{ getAdminPanelUrl() }}/settings/main" method="post">
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0 d-flex align-items-center">
                        ...
                        <input type="checkbox" name="value[multi_currency]" id="multiCurrencySwitch" value="1" checked="&quot;checked&quot;" class="custom-switch-input">
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="multiCurrencySwitch">Enable Multi-Currency</label>
                    </label>
                </div>
