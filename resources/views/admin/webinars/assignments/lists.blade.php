...
<input type="text" id="fsdate" class="text-center form-control datefilter" name="from" value="{{ request()->get('from') }}" placeholder="{{ trans('admin/main.start_date') }}">
</div>
</div>
</div>
...
<div class="input-group">
<input type="text" id="lsdate" class="text-center form-control datefilter" name="to" value="{{ request()->get('to') }}" placeholder="{{ trans('admin/main.end_date') }}">
</div>
</div>
</div>
